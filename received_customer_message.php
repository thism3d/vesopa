...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO customer_message (name, email, phone, message, comment) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $name, $email, $phone, $message, $comment);

    if ($stmt->execute()) {
        $row_affected = true;

        $mail_subject = 'New Customer Message From ' . $name;
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <!--<![endif]-->
        <title>Vesopa EPOS | Customer Message</title>
        <!--[if gte mso 9]>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
                                                                                    <img data-crop="false" src="https://vesopaepos.store/assets/email/envelope.png" style="max-width: 300px;" width="100%" border="0" alt="" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td class="py-35 px-50 mpx-15" style="border-radius: 10px; padding-top: 35px; padding-bottom: 35px; padding-left: 50px; padding-right: 50px; background-color: #f4ecfa;">
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td class="text-18 a-center c-purple pb-15" style="font-size:18px; line-height:22px; font-family: Arial, sans-serif; text-align:center; color:#9128df; padding-bottom: 15px;">
                                                                                                            <strong style="text-decoration: underline;">Message</strong>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td class="text-16 lh-26 a-center c-black" style="font-size:16px; font-family: Arial, sans-serif; line-height: 26px; text-align:center; color:#282828;">
                                                                                                            <em>"'. $message .'"</em>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td class="py-20" style="padding-top: 20px;">
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td class="text-18 a-center c-purple pb-15" style="font-size:16px; line-height:22px; font-family: Arial, sans-serif; padding-bottom: 15px;">
                                                                                                                        Comment: <strong><span style="color:#9128df;">'. $comment .'</span></strong>
                                                                                                                    </td>
                                                                                                                </tr>
...
if($row_affected){
    $title = 'Vesopa EPOS | Customer Message Received';
    ...
    echo '
        <div class="support_section">
            <div class="support_section_top">
                ...
                <h1 class="support_section_heading">Message Recevied!</h1>
