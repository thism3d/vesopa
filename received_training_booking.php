...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO training_request (name, email, phone, company, booking_time, message) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $name, $email, $phone, $company, $booking_time, $message);

    if ($stmt->execute()) {
        $row_affected = true;

        $mail_subject = 'New Training Request From '. $name;
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <!--<![endif]-->
        <title>Vesopa EPOS | Training Request</title>
        <!--[if gte mso 9]>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
                                                                                    <img data-crop="false" src="https://vesopaepos.store/assets/icons/HD_M250_062.png" style="max-width: 300px;" width="100%" border="0" alt="Training" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="py-20" style="padding-top: 20px;">
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td class="text-18 a-center c-purple pb-15" style="font-size:16px; line-height:22px; font-family: Arial, sans-serif; padding-bottom: 15px;">
                                                                                                                        DateTime: <strong><span style="color:#9128df;">'. $booking_time .'</span></strong>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td class="text-18 a-center c-purple pb-15" style="font-size:16px; line-height:22px; font-family: Arial, sans-serif; padding-bottom: 15px;">
                                                                                                                        Message: <strong><span style="color:#9128df;">'. $message .'</span></strong>
                                                                                                                    </td>
                                                                                                                </tr>
...
if($row_affected){
    $title = 'Vesopa EPOS | Training Request Received';
    ...
    echo '
        <div class="support_section">
            <div class="support_section_top">
                ...
                <h1 class="support_section_heading">Training Request Recevied!</h1>
