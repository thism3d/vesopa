...
$title = "Customer Help Messages | Vesopa EPOS Administration";
...
<div class="admin_middle_box_conatiner">
	...
	<div class="admin_middle_box_conatiner">
		...
		<div class="task_all_viewer_container">
			...
			<h2 style="color: #009688" class="all_r_task_header">Customer Help Messages</h2>
			...
			<div class="homepage_mid_container">
				...
				<div class="notification_section">
					...
					$sql = 'SELECT timeadded, id, name, email, phone, message, comment FROM customer_message ORDER BY id DESC;';
							...
							echo '
								<div class="mystd_single_student_container">
									<div class="mystd_single_student_left">
                                        ...
                                        <div class="mystd_other_info">
											<p class="message_customer">'. $row["comment"] .'</p>
										</div>
									...
									<div class="mystd_comment_keeper">
										...
										<form method="post" action="delete_customer_message">
											<input type="hidden" name="profile_id" value="'. $row["id"] .'">
											<button onClick="return confirmSubmitWithPopup(this, \'Do you really want to delete the message of '. $row["name"] .' ?\')" type="submit" class="all_member_active_rec_btn">
