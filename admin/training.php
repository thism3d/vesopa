...
$title = "Training Request | Vesopa EPOS Administration";
...
<div class="admin_middle_box_conatiner">
	...
	<div class="admin_middle_box_conatiner">
		...
		<div class="task_all_viewer_container">
			...
			<h2 style="color: #009688" class="all_r_task_header">Training Request</h2>
			...
			<div class="homepage_mid_container">
				...
				<div class="notification_section">
					...
					$sql = 'SELECT timeadded, id, name, email, phone, company, booking_time, message FROM training_request ORDER BY id DESC;';
								...
								<div class="mystd_single_student_container">
									<div class="mystd_single_student_left">
										...
										<div class="mystd_basic_info">
											...
											<p class="mystd_basic_info_bs"><span class="material-icons">schedule</span> '. $row["booking_time"] .'</p>
										</div>
									...
									<div class="mystd_comment_keeper">
										...
										<form method="post" action="delete_training_request">
											<input type="hidden" name="profile_id" value="'. $row["id"] .'">
											<button onClick="return confirmSubmitWithPopup(this, \'Do you really want to delete the training request of '. $row["name"] .' ?\')" type="submit" class="all_member_active_rec_btn">
